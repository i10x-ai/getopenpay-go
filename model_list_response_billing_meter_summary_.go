...
// checks if the ListResponseBillingMeterSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseBillingMeterSummary{}

// ListResponseBillingMeterSummary struct for ListResponseBillingMeterSummary
type ListResponseBillingMeterSummary struct {
	Data []BillingMeterSummary `json:"data"`
	PageNumber int32 `json:"page_number"`
	PageSize int32 `json:"page_size"`
	TotalObjects int32 `json:"total_objects"`
}

type _ListResponseBillingMeterSummary ListResponseBillingMeterSummary
...
func NewListResponseBillingMeterSummary(data []BillingMeterSummary, pageNumber int32, pageSize int32, totalObjects int32) *ListResponseBillingMeterSummary {
	this := ListResponseBillingMeterSummary{}
	this.Data = data
...
func (o ListResponseBillingMeterSummary) MarshalJSON() ([]byte, error) {
...
func (o ListResponseBillingMeterSummary) ToMap() (map[string]interface{}, error) {
...
func (o *ListResponseBillingMeterSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varListResponseBillingMeterSummary := _ListResponseBillingMeterSummary{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListResponseBillingMeterSummary)

	if err != nil {
		return err
	}

	*o = ListResponseBillingMeterSummary(varListResponseBillingMeterSummary)

	return err
}

type NullableListResponseBillingMeterSummary struct {
	value *ListResponseBillingMeterSummary
	isSet bool
}

func (v NullableListResponseBillingMeterSummary) Get() *ListResponseBillingMeterSummary {
	return v.value
}

func (v *NullableListResponseBillingMeterSummary) Set(val *ListResponseBillingMeterSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseBillingMeterSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseBillingMeterSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseBillingMeterSummary(val *ListResponseBillingMeterSummary) *NullableListResponseBillingMeterSummary {
	return &NullableListResponseBillingMeterSummary{value: val, isSet: true}
}

func (v NullableListResponseBillingMeterSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListResponseBillingMeterSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
