...
func NewPortalSessionExternal(id string, createdAt time.Time, updatedAt time.Time, accountId string, customerId string, returnUrl string, url string, token string) *PortalSessionExternal {
	...
	this.Id = id
	var object ObjectName = OBJECTNAME_PORTAL_SESSION
	this.Object = &object
...
func (o *PortalSessionExternal) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varPortalSessionExternal)
