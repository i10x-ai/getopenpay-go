...
const (
	...
	EVENTTYPE_CHECKOUT_SESSION_CREATED EventType = "checkout_session.created"
	EVENTTYPE_CHECKOUT_SESSION_COMPLETED EventType = "checkout_session.completed"
	EVENTTYPE_CHECKOUT_SESSION_EXPIRED EventType = "checkout_session.expired"
)
