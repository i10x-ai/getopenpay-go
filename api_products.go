...
func (r ApiSearchProductsRequest) SearchProductRequest(searchProductRequest SearchProductRequest) ApiSearchProductsRequest {
	r.searchProductRequest = &searchProductRequest
	return r
}

func (r ApiSearchProductsRequest) Execute() (*ListResponseProductExternal, *http.Response, error) {
...
// Execute executes the request
//  @return ListResponseProductExternal
func (a *ProductsAPIService) SearchProductsExecute(r ApiSearchProductsRequest) (*ListResponseProductExternal, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.searchProductRequest == nil {
		return localVarReturnValue, nil, reportError("searchProductRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.searchProductRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
