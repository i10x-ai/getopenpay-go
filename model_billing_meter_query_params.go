...
// checks if the BillingMeterQueryParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingMeterQueryParams{}

// BillingMeterQueryParams struct for BillingMeterQueryParams
type BillingMeterQueryParams struct {
...
func (o *BillingMeterQueryParams) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *BillingMeterQueryParams) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o BillingMeterQueryParams) MarshalJSON() ([]byte, error) {
...
func (o BillingMeterQueryParams) ToMap() (map[string]interface{}, error) {
...
func (o *BillingMeterQueryParams) UnmarshalJSON(data []byte) (err error) {
...
type NullableBillingMeterQueryParams struct {
	value *BillingMeterQueryParams
	isSet bool
}

func (v NullableBillingMeterQueryParams) Get() *BillingMeterQueryParams {
	return v.value
}

func (v *NullableBillingMeterQueryParams) Set(val *BillingMeterQueryParams) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingMeterQueryParams) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingMeterQueryParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingMeterQueryParams(val *BillingMeterQueryParams) *NullableBillingMeterQueryParams {
	return &NullableBillingMeterQueryParams{value: val, isSet: true}
}

func (v NullableBillingMeterQueryParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingMeterQueryParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
