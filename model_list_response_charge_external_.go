...
// checks if the ListResponseChargeExternal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseChargeExternal{}

// ListResponseChargeExternal struct for ListResponseChargeExternal
type ListResponseChargeExternal struct {
	Data []ChargeExternal `json:"data"`
	TotalObjects int32 `json:"total_objects"`
	PageNumber int32 `json:"page_number"`
	PageSize int32 `json:"page_size"`
}

type _ListResponseChargeExternal ListResponseChargeExternal
...
func NewListResponseChargeExternal(data []ChargeExternal, totalObjects int32, pageNumber int32, pageSize int32) *ListResponseChargeExternal {
	this := ListResponseChargeExternal{}
	this.Data = data
...
func (o ListResponseChargeExternal) MarshalJSON() ([]byte, error) {
...
func (o ListResponseChargeExternal) ToMap() (map[string]interface{}, error) {
...
func (o *ListResponseChargeExternal) UnmarshalJSON(bytes []byte) (err error) {
	...
	varListResponseChargeExternal := _ListResponseChargeExternal{}

	err = json.Unmarshal(bytes, &varListResponseChargeExternal)

	if err != nil {
		return err
	}

	*o = ListResponseChargeExternal(varListResponseChargeExternal)

	return err
}

type NullableListResponseChargeExternal struct {
	value *ListResponseChargeExternal
	isSet bool
}

func (v NullableListResponseChargeExternal) Get() *ListResponseChargeExternal {
	return v.value
}

func (v *NullableListResponseChargeExternal) Set(val *ListResponseChargeExternal) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseChargeExternal) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseChargeExternal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseChargeExternal(val *ListResponseChargeExternal) *NullableListResponseChargeExternal {
	return &NullableListResponseChargeExternal{value: val, isSet: true}
}

func (v NullableListResponseChargeExternal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListResponseChargeExternal) UnmarshalJSON(src []byte) error {
	v.isSet = true
