...
type SubscriptionItemExternal struct {
	...
	// Price object associated with subscription_item
...
func (o *SubscriptionItemExternal) SetDescriptionNil() {
...
func (o *SubscriptionItemExternal) UnmarshalJSON(data []byte) (err error) {
