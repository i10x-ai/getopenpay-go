...
// checks if the ListResponseCreditNoteExternal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseCreditNoteExternal{}

// ListResponseCreditNoteExternal struct for ListResponseCreditNoteExternal
type ListResponseCreditNoteExternal struct {
	Data []CreditNoteExternal `json:"data"`
	TotalObjects int32 `json:"total_objects"`
	PageNumber int32 `json:"page_number"`
	PageSize int32 `json:"page_size"`
}

type _ListResponseCreditNoteExternal ListResponseCreditNoteExternal
...
func NewListResponseCreditNoteExternal(data []CreditNoteExternal, totalObjects int32, pageNumber int32, pageSize int32) *ListResponseCreditNoteExternal {
	this := ListResponseCreditNoteExternal{}
	this.Data = data
...
func (o ListResponseCreditNoteExternal) MarshalJSON() ([]byte, error) {
...
func (o ListResponseCreditNoteExternal) ToMap() (map[string]interface{}, error) {
...
func (o *ListResponseCreditNoteExternal) UnmarshalJSON(bytes []byte) (err error) {
	...
	varListResponseCreditNoteExternal := _ListResponseCreditNoteExternal{}

	err = json.Unmarshal(bytes, &varListResponseCreditNoteExternal)

	if err != nil {
		return err
	}

	*o = ListResponseCreditNoteExternal(varListResponseCreditNoteExternal)

	return err
}

type NullableListResponseCreditNoteExternal struct {
	value *ListResponseCreditNoteExternal
	isSet bool
}

func (v NullableListResponseCreditNoteExternal) Get() *ListResponseCreditNoteExternal {
	return v.value
}

func (v *NullableListResponseCreditNoteExternal) Set(val *ListResponseCreditNoteExternal) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseCreditNoteExternal) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseCreditNoteExternal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseCreditNoteExternal(val *ListResponseCreditNoteExternal) *NullableListResponseCreditNoteExternal {
	return &NullableListResponseCreditNoteExternal{value: val, isSet: true}
}

func (v NullableListResponseCreditNoteExternal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListResponseCreditNoteExternal) UnmarshalJSON(src []byte) error {
	v.isSet = true
