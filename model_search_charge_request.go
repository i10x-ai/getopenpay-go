...
// checks if the SearchChargeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchChargeRequest{}

// SearchChargeRequest struct for SearchChargeRequest
type SearchChargeRequest struct {
	// Page number
...
type _SearchChargeRequest SearchChargeRequest
...
func (o SearchChargeRequest) MarshalJSON() ([]byte, error) {
...
func (o SearchChargeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SearchChargeRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSearchChargeRequest := _SearchChargeRequest{}

	err = json.Unmarshal(bytes, &varSearchChargeRequest)

	if err != nil {
		return err
	}

	*o = SearchChargeRequest(varSearchChargeRequest)

	return err
}

type NullableSearchChargeRequest struct {
	value *SearchChargeRequest
	isSet bool
}

func (v NullableSearchChargeRequest) Get() *SearchChargeRequest {
	return v.value
}

func (v *NullableSearchChargeRequest) Set(val *SearchChargeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchChargeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchChargeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchChargeRequest(val *SearchChargeRequest) *NullableSearchChargeRequest {
	return &NullableSearchChargeRequest{value: val, isSet: true}
}

func (v NullableSearchChargeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchChargeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
