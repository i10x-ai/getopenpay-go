...
func NewPayInvoiceRequest() *PayInvoiceRequest {
	...
	var voidOnFailure bool = false
	this.VoidOnFailure = &voidOnFailure
	return &this
}
...
// GetVoidOnFailure returns the VoidOnFailure field value if set, zero value otherwise.
func (o *PayInvoiceRequest) GetVoidOnFailure() bool {
	if o == nil || IsNil(o.VoidOnFailure) {
		var ret bool
		return ret
	}
	return *o.VoidOnFailure
}

// GetVoidOnFailureOk returns a tuple with the VoidOnFailure field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PayInvoiceRequest) GetVoidOnFailureOk() (*bool, bool) {
	if o == nil || IsNil(o.VoidOnFailure) {
		return nil, false
	}
	return o.VoidOnFailure, true
}
...
// SetVoidOnFailure gets a reference to the given bool and assigns it to the VoidOnFailure field.
