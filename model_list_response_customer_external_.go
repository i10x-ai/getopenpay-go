...
// checks if the ListResponseCustomerExternal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseCustomerExternal{}

// ListResponseCustomerExternal struct for ListResponseCustomerExternal
type ListResponseCustomerExternal struct {
	Data []CustomerExternal `json:"data"`
	TotalObjects int32 `json:"total_objects"`
	PageNumber int32 `json:"page_number"`
	PageSize int32 `json:"page_size"`
}

type _ListResponseCustomerExternal ListResponseCustomerExternal
...
func NewListResponseCustomerExternal(data []CustomerExternal, totalObjects int32, pageNumber int32, pageSize int32) *ListResponseCustomerExternal {
	this := ListResponseCustomerExternal{}
	this.Data = data
...
func (o ListResponseCustomerExternal) MarshalJSON() ([]byte, error) {
...
func (o ListResponseCustomerExternal) ToMap() (map[string]interface{}, error) {
...
func (o *ListResponseCustomerExternal) UnmarshalJSON(bytes []byte) (err error) {
	...
	varListResponseCustomerExternal := _ListResponseCustomerExternal{}

	err = json.Unmarshal(bytes, &varListResponseCustomerExternal)

	if err != nil {
		return err
	}

	*o = ListResponseCustomerExternal(varListResponseCustomerExternal)

	return err
}

type NullableListResponseCustomerExternal struct {
	value *ListResponseCustomerExternal
	isSet bool
}

func (v NullableListResponseCustomerExternal) Get() *ListResponseCustomerExternal {
	return v.value
}

func (v *NullableListResponseCustomerExternal) Set(val *ListResponseCustomerExternal) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseCustomerExternal) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseCustomerExternal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseCustomerExternal(val *ListResponseCustomerExternal) *NullableListResponseCustomerExternal {
	return &NullableListResponseCustomerExternal{value: val, isSet: true}
}

func (v NullableListResponseCustomerExternal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListResponseCustomerExternal) UnmarshalJSON(src []byte) error {
	v.isSet = true
