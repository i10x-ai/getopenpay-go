...
func NewSetupIntentExternal(id string, createdAt time.Time, updatedAt time.Time, accountId string, customerId NullableString, paymentMethodIds []string) *SetupIntentExternal {
	...
	this.Id = id
	var object ObjectName = OBJECTNAME_SETUP_INTENT
	this.Object = &object
...
func (o *SetupIntentExternal) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSetupIntentExternal)
