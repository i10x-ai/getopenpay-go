...
// checks if the SearchInvoiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchInvoiceRequest{}

// SearchInvoiceRequest struct for SearchInvoiceRequest
...
type _SearchInvoiceRequest SearchInvoiceRequest
...
func (o SearchInvoiceRequest) MarshalJSON() ([]byte, error) {
...
func (o SearchInvoiceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SearchInvoiceRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSearchInvoiceRequest := _SearchInvoiceRequest{}

	err = json.Unmarshal(bytes, &varSearchInvoiceRequest)

	if err != nil {
		return err
	}

	*o = SearchInvoiceRequest(varSearchInvoiceRequest)

	return err
}

type NullableSearchInvoiceRequest struct {
	value *SearchInvoiceRequest
	isSet bool
}

func (v NullableSearchInvoiceRequest) Get() *SearchInvoiceRequest {
	return v.value
}

func (v *NullableSearchInvoiceRequest) Set(val *SearchInvoiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchInvoiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchInvoiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchInvoiceRequest(val *SearchInvoiceRequest) *NullableSearchInvoiceRequest {
	return &NullableSearchInvoiceRequest{value: val, isSet: true}
}

func (v NullableSearchInvoiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchInvoiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
