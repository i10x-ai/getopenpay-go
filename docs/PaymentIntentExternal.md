...
------------ | ------------- | ------------- | -------------
**Id** | **string** |  | 
**Object** | Pointer to [**ObjectName**](ObjectName.md) |  | [optional] [default to OBJECTNAME_PAYMENT_INTENT]
...
**PaymentProcessorName** | [**NullablePaymentProcessorName**](PaymentProcessorName.md) |  | 
