...
**CollectionMethod** | [**CollectionMethodEnum**](CollectionMethodEnum.md) | Invoices that are generated from this subscription have this collection method. | 
...
**Status** | [**SubscriptionStatusEnum**](SubscriptionStatusEnum.md) | Current status of the subscription. | 
**SubscriptionItems** | [**[]SubscriptionItemExternal**](SubscriptionItemExternal.md) | List of subscription items. | 
