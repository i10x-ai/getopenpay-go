...
**BillingScheme** | [**BillingSchemeEnum**](BillingSchemeEnum.md) | Describes how to compute the price per period. | 
...
**PriceTiers** | [**[]PriceTierExternal**](PriceTierExternal.md) | List of price_tiers. | 
