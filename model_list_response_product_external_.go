...
// checks if the ListResponseProductExternal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseProductExternal{}

// ListResponseProductExternal struct for ListResponseProductExternal
type ListResponseProductExternal struct {
	Data []ProductExternal `json:"data"`
	TotalObjects int32 `json:"total_objects"`
	PageNumber int32 `json:"page_number"`
	PageSize int32 `json:"page_size"`
}

type _ListResponseProductExternal ListResponseProductExternal
...
func NewListResponseProductExternal(data []ProductExternal, totalObjects int32, pageNumber int32, pageSize int32) *ListResponseProductExternal {
	this := ListResponseProductExternal{}
	this.Data = data
...
func (o ListResponseProductExternal) MarshalJSON() ([]byte, error) {
...
func (o ListResponseProductExternal) ToMap() (map[string]interface{}, error) {
...
func (o *ListResponseProductExternal) UnmarshalJSON(bytes []byte) (err error) {
	...
	varListResponseProductExternal := _ListResponseProductExternal{}

	err = json.Unmarshal(bytes, &varListResponseProductExternal)

	if err != nil {
		return err
	}

	*o = ListResponseProductExternal(varListResponseProductExternal)

	return err
}

type NullableListResponseProductExternal struct {
	value *ListResponseProductExternal
	isSet bool
}

func (v NullableListResponseProductExternal) Get() *ListResponseProductExternal {
	return v.value
}

func (v *NullableListResponseProductExternal) Set(val *ListResponseProductExternal) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseProductExternal) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseProductExternal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseProductExternal(val *ListResponseProductExternal) *NullableListResponseProductExternal {
	return &NullableListResponseProductExternal{value: val, isSet: true}
}

func (v NullableListResponseProductExternal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListResponseProductExternal) UnmarshalJSON(src []byte) error {
	v.isSet = true
