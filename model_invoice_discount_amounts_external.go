...
func NewInvoiceDiscountAmountsExternal(discountId string, amountAtom int32) *InvoiceDiscountAmountsExternal {
	...
	var object ObjectName = OBJECTNAME_INVOICE_DISCOUNT
	this.Object = &object
...
func (o *InvoiceDiscountAmountsExternal) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varInvoiceDiscountAmountsExternal)
